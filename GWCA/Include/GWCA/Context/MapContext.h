...
namespace GW
{
    ...
    struct PropsContext
    {
        ...
        uint8_t pad1[0x6C];
        /* +h006C */
        Array<TList<PropByType>> propsByType;
        /* +h007C */
        uint8_t h007C[0x28];
        /* +h00A4 */
        Array<PropModelInfo> propModels;
        /* +h00B4 */
        uint8_t h00B4[0xE0];
        /* +h0194 */
        Array<MapProp*> propArray;
    };
    ...
    struct MapContext
    {
        ...
        /* +h005C */
        float h005C[6]; // Some trapezoid i think.
        /* +h0074 */
        struct sub1
        {
            struct sub2
            ...
            /* +h0004 */
            Array<uint32_t> pathing_map_block;
            /* +h0014 */
            uint32_t h0014[0x13];
            /* +h0060 */
            Array<TList<void*>> something_else_for_props;
